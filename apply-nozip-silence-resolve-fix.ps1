...
$PatchFile = Join-Path $ProjectRoot "_nozip_silence_resolve_fix.cjs"
...
Write-Host ""
Write-Host "Silence resolve patch complete. Restart server/client and hard refresh browser." -ForegroundColor Green