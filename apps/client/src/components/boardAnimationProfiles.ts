...
const PROFILES: Record<BoardRenderEventType, BoardAnimationProfile> = {
  ...
  SCHEDULED_EFFECT_RESOLVED: { durationMs: 320, label: "scheduled-resolve" },
  STAT_MODIFIER_APPLIED: { durationMs: 420, label: "stat-modifier" },
  STAT_MODIFIER_REMOVED: { durationMs: 320, label: "stat-modifier-remove" },
  PLAYER_STAT_CHANGED: { durationMs: 420, label: "player-stat" },
  CEMETERY_HP_CHANGED: { durationMs: 520, label: "cemetery-hp" },
  ...
  TURN_STARTED: { durationMs: 220, label: "turn-start" },
  TURN_PHASE_CHANGED: { durationMs: 180, label: "phase-change" },
