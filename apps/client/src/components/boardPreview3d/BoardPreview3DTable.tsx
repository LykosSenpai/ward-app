...
export function BoardPreview3DTable({ zoomScale, tiltDegrees, heightScale, showAnchors, selectedSlotId, filteredBoardObjects, resolveSlotPosition, onSelectSlot, onSelectPiece }: Props) {
  return (
    <div className="board-preview-3d__camera" style={{ transform: `scale(${zoomScale})` }}>
